...
package com.laifeng.view.barrage
{
	...
	public class BarrageItemHorn extends Sprite implements IBarrage
	{
		...
		public function setInfo(info:Object):void
		{
			...
			var name:String = "<font size='22' color='#ffeba6' face='微软雅黑,Microsoft YaHei,Arial'>";
			name += info["info"]["n"]+"：";
			name += "</font>";
			
			var msg:String = "<font size='22' color='#ffeba6' face='微软雅黑,Microsoft YaHei,Arial'>";
			msg+= info["info"]["m"];
			msg+="</font>";
